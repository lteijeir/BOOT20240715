...
FROM EMPLOYEES E WHERE SALARY > 6000
GROUP BY E.DEPARTMENT_ID
ORDER BY Empleados,1;
/
SELECT E.DEPARTMENT_ID, E.LAST_NAME, SALARY, (SELECT AVG(SALARY) FROM EMPLOYEES D WHERE E.DEPARTMENT_ID =  D.DEPARTMENT_ID) * 100 media 
FROM EMPLOYEES E;